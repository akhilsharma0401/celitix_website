...
const page = () => {
  ...
  const tabContent = {
    ...
    Healthcare: {
      title: "Healthcare",
      description: "Manage appointment scheduling, reminders, and follow-ups automatically.Share prescriptions, lab reports, and test updates securely via WhatsApp.Send health awareness tips, vaccination alerts, or wellness reminders.Enable 24/7 patient support with automated symptom triage or FAQs.",
      useCases: [
    ...
    Finance: {
      title: "Finance",
      description: "Provide account updates, balance alerts, and EMI reminders securely.Automate loan eligibility checks and document verification.Offer instant customer support for transactions and services.Deliver investment tips, statements, or policy renewals automatically.",
      useCases: [
    ...
    Education: {
      title: "Education",
      description: "Automate student inquiries, registrations, and fee payment reminders.Send class schedules, exam results, and admission updates instantly.Enable multi-language support for parents and international students.Collect feedback and satisfaction surveys seamlessly.",
      useCases: [
    ...
    Hospitality: {
      title: "Hospitality",
      description: "Manage room bookings, confirmations, and cancellations via WhatsApp.Share check-in details, offers, and personalized experiences pre-arrival.Handle guest feedback, concierge requests, or service support in real time.Promote special packages, events, or loyalty programs automatically.",
      useCases: [
    ...
    "Real Estate": {
      ...
      description: "Qualify leads by asking questions like “What’s your budget?” or “Preferred location?”Send property listings, photos, and virtual tours instantly.Schedule site visits or follow-ups with automated reminders.Notify clients about new projects or investment opportunities. ",
      useCases: [
    ...
    "Food & Beverage": {
      title: "Food & Beverage",
      description: "Automate table reservations, order tracking, and menu sharing.Send offers, loyalty points, and personalized discounts to repeat customers.Handle delivery updates and feedback collection automatically.Enable WhatsApp ordering directly from your restaurant or cloud kitchen.",
      useCases: [
    ...
    "Tech Startups": {
      title: "Tech Startups",
      description: "Automate customer onboarding, demo scheduling, and product FAQs. Provide real-time support for app or software issues.Send product updates, feature releases, and beta invites instantly.Collect feedback from early adopters to improve user experience.Track frequently asked questions.",
      useCases: [
  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10 pb-5 lg:pb-20">
          ...
          <div className='box-reveal-left space-y-6'>
            ...
            <p className="text-gray-600 sub-heading text-base md:text-lg  max-w-md">
              No-Code WhatsApp Chatbots automate customer conversations,
              capture leads, integrate and deliver instant support — all
              from one platform. Simplify communication and scale your
      ...
      <section className="py-20 bg-white md:space-y-20 space-y-10">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 box-reveal-left">
            ...
            <ul className="space-y-3 text-gray-700 text-md sub-heading list-disc list-inside">
              ...
              <li>No technical skills required to create or manage the chatbot.</li>
              <li>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 box-reveal-left">
            ...
            <ul className="space-y-3 text-gray-700 text-md sub-heading list-disc list-inside">
              <li>Create drag-and-drop chat flows for order updates, booking confirmations, and return requests in minutes.</li>
              <li>Assist customers worldwide in 90+ languages, anytime — without hiring additional support staff.</li>
              <li>Send instant updates and notifications.</li>
              <li>Automate routine conversations like “Where’s my order?” so your team can focus on solving complex issues faster.</li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 box-reveal-left">
            ...
            <ul className="space-y-3 text-gray-700 text-md sub-heading list-disc list-inside">
              <li>Smart Routing Rules: Assign conversations based on location, department, priority, or agent availability.</li>
              <li>Balanced Workload Distribution: Keep your team efficient by automatically rotating chats among available agents.</li>
              <li>Faster Conversions: Ensure every qualified lead reaches the right expert instantly, reducing response time and improving closure rates.</li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 box-reveal-left">
            ...
            <ul className="space-y-3 text-gray-700 text-md sub-heading list-disc list-inside">
              <li>Simplify Conversations: Let your customers book appointments, register, or share feedback —With the help of Chatbot.</li>
              <li>Collect Accurate Information: Use rich input fields like date pickers, drop-downs, and buttons and many more options to capture details correctly the first time.</li>
              <li>Enhance Engagement: Combine Chat Flows with AI-powered chat to deliver smooth, guided journeys that keep users engaged and minimize drop-offs.</li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-16 grid grid-cols-12 gap-8 items-center">
            ...
            <div className="col-span-12 md:col-span-5 grid grid-cols-2 gap-8">
              <Tile icon="/integrations/salesforce.svg" />
              <Tile icon="/integrations/zoho.svg" />
              <Tile icon="/integrations/google-sheets.svg" />
              <Tile icon="/integrations/leadsquared.svg" />
            </div>

            {/* Center Big Tile */}
            <div className="col-span-12 md:col-span-2 flex justify-center">
              <div className="w-full h-72 rounded-tl-4xl rounded-br-4xl bg-white shadow-md" />
            </div>

            {/* Right Block */}
            <div className="col-span-12 md:col-span-5 grid grid-cols-2 gap-8">
              <Tile icon="/integrations/woocommerce.svg" />
              <Tile />
              <Tile icon="/integrations/freshworks.svg" />
              <Tile />
            </div>
