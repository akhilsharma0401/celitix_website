...
import { CTALASTIMAGE, Ecommerce, Education, Finance, FoodAutomate, foodbeverage, FoodBeverage, FoodBeverage2nd, FoodBeverage4th1, FoodBeverage4th2, FoodBeverage4th3, FoodCommunicate, FOODhero, FoodKeep, FoodSimplify, Healthcare, Hospitality, ProfessionalServices, RealEstateConstruction, TechStartups } from '../../../public/assets/images';
...
const FoodProduction = () => {
  ...
  const features = [
    {
      ...
      desc: "Send menu updates, order statuses, deals, or inventory info across WhatsApp, SMS, and Voice in seconds.",
      icon: FoodCommunicate,
    },
    {
      title: "Automate Updates ",
      desc: "Trigger reminders for re-orders, subscription renewals, loyalty points, and feedback requests automatically.",
      icon: FoodAutomate,
    },
    {
      title: "Simplify Promotions",
      desc: "Launch new menu items, special bundles, or seasonal discounts directly to your customers, no ads needed.",
      icon: FoodSimplify,
    },
    {
      title: "Keep Stock Moving ",
      desc: "Nudge regulars for quick clearances, fresh batches, or limited-time offers based on inventory cycles.",
      icon: FoodKeep,
    },
  ];
  // 2nd
  ...
  // 4th
  const [mainTab, setmainTab] = useState("Speed Up Sales");

  const maintabs = ["Speed Up Sales", "Delight Customers", "Work Smarter "];

  const maintabContent = {
    "Speed Up Sales": [
      "Promote bestsellers, combos, or fresh arrivals instantly.",
      "Confirm orders or reservation slots with real-time messages.",
      "Share flash sales or sell-through inventory on slow days.",
      "Let customers reorder easily with pre-filled links.",

    ],
    "Delight Customers": [
      "Trigger thank-you messages after orders automatically.",
      "Share loyalty rewards, points balance, or birthday offers.",
      "Route complaints, changes, or refunds smoothly to staff.",
      "Invite customers to private launches or limited editions.",

    ],
    "Work Smarter ": [
      "Push perishable goods before expiry with timed promos.",
      "Offer bundles, packs, or clearances for grocery sections.",
      "Automate reminders for subscription boxes or bulk orders.",
      "Update store hours, stockouts, or delivery changes fast.",

    ],
  };

  const tabImages = {
    "Speed Up Sales": FoodBeverage4th1,
    "Delight Customers": FoodBeverage4th2,
    "Work Smarter ": FoodBeverage4th3,
  };
  // 4th
  ...
  const tabs = [
    "Ecommerce", "Healthcare", "Finance", "Education", "Hospitality",
    "Real Estate", "Professional Services", "Tech Startups"
  ];
  ...
  const faqs = [
    {
      question: "Can Celitix help us with delivery updates?",
      answer:
        "Yes. You can send order confirmations, ready-for-pickup alerts, and delivery tracking messages across channels.",
    },
    {
      question: "Can we automate loyalty and repeat sales?",
      answer:
        "Absolutely. Set up reward triggers, birthday campaigns, refill reminders, or limited-time offers.",
    },
    {
      question: "Will it work for cloud kitchens and packaged food sellers?",
      answer:
        "Yes. Whether you run a virtual kitchen, bakery, or grocery outlet, Celitix fits your model with customer-friendly communication.",
    },
    {
      question: "Can we share catalogs, menus, or promos easily?",
      answer:
        "Yes. Use WhatsApp catalogs, quick links, rich cards, and SMS blasts to promote your offerings without paid ads.",
    },
    {
      question: "What happens if customers miss a message?",
      answer:
        "You can use Celitix to follow up via SMS, RCS, or voice call, so no order, promo, or update goes unseen.",
    },
  ...
  return (
    <div>
      ...
      {/* <Helmet>
        <title> Growth Platform for Food, Delivery & Retail Brands | Celitix        </title>
        <meta name="description" content="Boost loyalty, manage orders, & engage customers. Celitix helps restaurants, cloud kitchens, bakeries, and food retailers grow with smarter communication." />
      </Helmet> */}
      {/* 1st */}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10 pb-10 md:pb-20">
          <div className="space-y-6 box-reveal-left">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl heading font-bold text-gray-900 popf leading-tight">
              Serve<span className="text-transparent bg-clip-text  bg-gradient-to-r from-[#2b40b0] to-[#36bae2]"> Better </span> with Celitix
            </h1>

            <p className="text-gray-600 text-base md:text-lg pera max-w-md">
              From orders to offers, Celitix helps you keep customers in the loop, build loyalty, and drive repeat sales, without extra apps or heavy tech.
            </p>
      ...
      <section className="bg-[#f7ebfc] px-4 sm:px-6 lg:px-20 py-5 md:py-10">
        <div className="max-w-screen-xl mx-auto">
          <h2 className="text-2xl md:text-4xl lg:text-5xl heading text-center pb-5 md:pb-15">
            More Orders, More Loyalty, Less Hassle
          </h2>
        ...
        <div className=" bg-linear-to-r from-[#6b0da1] to-[#8447c6] grid grid-cols-1 md:grid-cols-2 h-auto py-10 px-6 sm:px-8 rounded-3xl shadow-2xl w-full sm:w-11/12 md:w-11/12 mx-auto items-center gap-8">
          ...
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            <p className="text-sm md:text-lg sub-heading text-white font-light popf mt-2">
              See how Celitix helps brands sell smarter, from the first order to the fifth refill.
      ...
      <section className="bg-[#f7ebfc] px-4 sm:px-6 md:px-12 py-5 md:py-20">
        <div className="max-w-screen-xl mx-auto">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl pb-2 md:pb-5 text-center heading text-purple-800 mb-3">
            Built for Kitchens, Shops & Delivery Brands
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="max-w-xl mx-auto lg:mx-0 text-gray-800">
              <h3 className="text-xl md:text-3xl sub-heading text-purple-700 mb-4">
                {mainTab === "Showcase Products & Menus"
                  ? "Promote Directly Using Rich Media + Automations"
                  : mainTab === "Delight Customers"
                    ? "Build Relationships That Matter"
                    : "Improve Operations, Optimise ROI"}
              </h3>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between bg-gradient-to-r from-[#A05CD7] to-[#4B0FA6] px-6 md:px-12 py-5 md:py-20">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h2 className="text-white  text-2xl sm:text-3xl md:text-4xl heading font-bold mb-4">
            Sell Smarter, Serve Faster
          </h2>
          <p className="text-gray-200 text-sm sm:text-base md:text-lg sub-heading font-light mb-6 max-w-xl">
            With Celitix, you can keep customers informed, happy, and coming back, all without complicated systems.
          </p>
          <UniversalButton
            label="Start Now"
            variant="transitionbtn"
      ...
      <div className="bg-[#f7ebfc] py-2 md:py-10 px-6 sm:px-10">
        ...
        <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 lg:gap-12 px-4 sm:px-8 lg:px-20 py-2 md:py-5">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            <h2 className="text:xl md:text-3xl lg:text-4xl heading font-semibold text-gray-800 mb-4">
              {tabContent[activeTabs]?.title || "Ecommerce"}
            </h2>
            <p className="text-lg sub-heading text-gray-600 mb-6">
      ...
      {/* 6th */}
      {/* 7th */}
      <div className=" bg-[#f7ebfc] flex justify-center items-center py-8 md:pb-15 px-4">
        <div className="w-full max-w-4xl bg-[#F7F4F9] border border-[#D1CDE3] rounded-xl p-6 shadow-lg">
          <h2 className="text-2xl md:text-4xl heading font-semibold text-center text-gray-900 popf mb-8">
            Celitix for Food & Beverage FAQs
          </h2>
