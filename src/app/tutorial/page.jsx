...
const cards = [
  ...
  },
  {
    ...
    category: "WhatsApp API",
    title:
      "How Much Time Does It Take to Get the WhatsApp Business API Approved",
    desc: "Run marketing campaigns and customer engagement on WhatsApp.",
  ...
  },
  {
    icon: <FiBookOpen />,
    category: "WhatsApp API",
    title: "Unlock Higher Engagement and Conversions with WhatsApp’s 24-Hour Service Window",
    desc: "Run marketing campaigns and customer engagement on WhatsApp.",
    color: "from-green-600 to-teal-500",
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10 pb-5 lg:pb-16 py-5 md:py-10">
          ...
          <div className="space-y-6 box-reveal-left">
            ...
            <p className="text-gray-600  text-base md:text-lg  max-w-lg">
              A Gateway to Guides and Tutorials for Using Celitix’s Omnichannel
              Communication Platform, Helping Businesses Understand and
              Implement Messaging and Engagement Tools.
            </p>
          ...
          {paginatedCards.map((card, index) => (
            <div key={index} className="group h-full">
              ...
              >
                {/* Shine */}
                <div
                  className="absolute inset-0 bg-gradient-to-tr from-white/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition pointer-events-none
                "
                />
                {/* Content */}
