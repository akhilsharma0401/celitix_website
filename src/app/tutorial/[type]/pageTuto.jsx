...
const PageTuto = ({ params }) => {
  ...
  // Find matching tutorial
  const tutorial = tutorialData.find((item) => item.slug === type);
  ...
  // ✅ ADD ONLY THIS (no UI change)
  const renderTextWithLinks = (text, keywords = []) => {
            ...
            {tutorial.sections.map((section, index) => {
              ...
              return (
                ...
                >
                  ...
                  {section.answer && (
                    <p className="text-gray-700 leading-relaxed whitespace-pre-line pera p-0 mb-3 text-justify">
                      {renderTextWithLinks(section.answer, section.keywords)}
                    </p>
                  )}
                  ...
                  {section.subanswer && (
                    <p className="text-gray-700 leading-relaxed whitespace-pre-line pera p-0 mb-3 text-justify">
                      {renderTextWithLinks(section.subanswer, section.keywords)}
                    </p>
                  )}
                  ...
                  {section.list && (
                    <ul className="list-disc pl-6 space-y-2 pera text-gray-700 text-justify mb-1">
                      {section.list.map((item, i) => (
                        <li key={i}>
                          {renderTextWithLinks(item, section.keywords)}
                        </li>
                      ))}
                    </ul>
                  )}
