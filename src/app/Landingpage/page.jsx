...
const Landingpage = () => {
  ...
  const tabData = [
    ...
    },
    {
      title: "RCS",
      intro:
        "Add next-gen native messaging to your communication. Intrigue customers with richer experiences on their native messaging apps. Differentiate yourself from the competition.",
      bullets: [
    ...
    },
    {
      title: "SMS",
      intro:
        "Ensure maximum reach and reliable message delivery with the world’s most tried-and-tested communication channel. Perfect for times when getting the word out is all that matters.",
      bullets: [
    ...
    },
    {
      title: "2 Way SMS",
      intro:
        "Give customers new and interesting ways to engage with your brand: Automate subscriptions, balance checks, and content sharing using customisable keyword-triggered actions.",
      bullets: [
    ...
    },
    {
      title: "Email OTP",
      intro:
        "Secure your customers with reliable, email-based verification. Whether it’s MFA logins, transactions, or account changes, Email OTP offers a unique channel for specific use cases.",
      bullets: [
    ...
    },
    {
      ...
      intro:
        "Improve your workflow with a cloud-powered multi-agent dashboard for sales, support, and customer service. Perfect for outreach, urgency, and bulk voice call campaigns.",
      bullets: [
    ...
    },
    {
      ...
      intro:
        "Never miss a call again; Automate greetings with a virtual receptionist. Add, manage, or remove your Interactive Voice Response (IVR) systems, right from Celitix's integrated dashboard.",
      bullets: [
    ...
    },
    {
      title: "Click2Call",
      intro:
        "Elevate your mobile app’s user experience with one-touch calling. Make it effortless and convenient for your customers to connect with your team. Celitix simplifies app development.",
      bullets: [
    ...
    },
    {
      ...
      intro:
        "Boost engagement with a dedicated missed call number. The system auto-responds to customer calls with 100% customisable actions. Use it for voting, taking polls, or contests!",
      bullets: [
    ...
    },
    {
      title: "Verification",
      intro:
        "Add user verification or multi-factor authentication to your app, website, or platform. Gain trust by securing user data and protecting account access. Crucial for healthcare and finance.",
      bullets: [
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <ul className="flex flex-wrap justify-center gap-4 mb-5 md:mb-10">
            {features.map((f, i) => (
              ...
              >
                ...
                <span className="text-gray-700 text-lg md:text-xl sub-heading">
                  {f}
                </span>
              </li>
            ))}
                  ...
                  <div className="space-y-4 bg-[#F5F8FB] border border-gray-300 rounded-xl p-4 md:p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <option value="User Verification">
                          Chatbot Services
                        </option>
      ...
      <section className="py-5 md:py-10 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-700 sub-heading text-md md:text-lg mb-8">
            Delight customers on their preferred channels for business
            communication. Engage with them in multiple ways to discover, enjoy,
            and choose from.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-left">
              <h3 className="text-xl md:text-3xl heading text-gray-800 mb-4">
                {title}
              </h3>
              <p className="text-gray-700 text-md md:text-lg sub-heading mb-5">
                {intro}
              </p>
              <ul className="space-y-3 mb-6">
                {bullets.map((b, i) => (
                  <li key={i} className="flex items-start">
                    ...
                    <span className="sub-heading text-md md:text-lg text-gray-700">
                      {b}
                    </span>
                  </li>
                ))}
            ...
            {mockup && (
              <div className="relative flex justify-center md:justify-end">
                <Image
                  src={mockup}
                  alt={`${title} mockup`}
                  className="w-64 md:w-80 lg:w-120 h-56 md:h-96"
                />
              </div>
            )}
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-700 text-md md:text-lg sub-heading mb-6">
              <span className="text-green-600 font-semibold">Loyalty</span> =
              trust over time. Delight customers with outstanding experiences
              while everyone else struggles to do the bare minimum. Automate,
              standardise, and go systemic for consistency!
            </p>
            <UniversalButton
              label="Explore More"
              variant="brutal"
      ...
      <section className="py-5 md:py-10 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-700 sub-heading text-md md:text-lg mb-8">
            A scalable communication system improves customer experience,
            reduces workload, and boosts profit
          </p>
        ...
        `}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-left">
              ...
              <UniversalButton
                label={activemainTab.buttonText}
                variant="brutal"
                className="bg-[#9B44B6] border-[#9B44B6] text-white px-3 py-2 font-semibold hover:bg-white hover:text-black 
              hover:shadow-[4px_4px_0px_#9B44B6] mt-2"
                onClick={() => {
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12 items-center">
          ...
          <div>
            <h2 className="text-2xl md:text-4xl heading font-bold mb-4">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2b40b0] to-[#36bae2] ">
                Offering Robust Integrations
              </span>{" "}
              & Custom Workflows
            </h2>
            <p className="text-gray-700 text-md md:text-lg sub-heading mb-6">
              Connect business SaaS apps like{" "}
              <span className="text-green-600 font-semibold">CRM</span>,
              accounting, HR, etc. with your communication platform. Scale,
              grow, analyze, automate, and manage operations from one place.
            </p>
            <UniversalButton
              label="Explore More"
              variant="brutal"
