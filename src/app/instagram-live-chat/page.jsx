...
const Page = () => {
  ...
  const faqs = [
    {
      question: "What is an Instagram Live Chat Service?",
      answer:
        "An Instagram Live Chat Service helps businesses manage their Instagram messages, customer conversations, comments, and support messages in time. This is done from a dashboard.",
    },
    {
      question: "How does Instagram Live Chat help businesses?",
      answer:
        "Instagram Live Chat helps businesses. They can respond faster to customers. This improves engagement. They can also generate leads. Businesses can manage support requests. They can increase conversions. This is all done through messaging on Instagram.",
    },
    {
      question: "Can multiple agents manage Instagram chats together?",
      answer:
        "Yes, businesses can use a team inbox. Multiple agents can handle Instagram messages. This way, sales and support teams can work together. They won't miss any customer messages.",
    },
    {
      question: "Can Instagram Live Chat be integrated with CRM systems?",
      answer:
        "Yes, some Instagram Live Chat platforms can connect with CRM systems. This helps sync customer data. It also syncs conversation history. Lead information automatically.",
    },
    {
      question: "Does Instagram Live Chat support automation and chatbots?",
      answer:
        "Yes, businesses can automate some tasks. They can use chatbots to reply to customers. Chatbots can answer FAQs. They can qualify leads. Chatbots can also send messages. They can help with customer engagement.",
    },
    {
      question:
        "Can I manage Instagram comments and messages from one platform?",
      answer:
        "Yes, Instagram Live Chat platforms can help. Businesses can manage comments, story replies, reactions, and direct messages. All of this can be done from one platform.",
    },
    {
      question: "Why should businesses use Instagram Live Chat Services?",
      answer:
        "Businesses use Instagram Live Chat Services for reasons. They want to engage with customers. They want to respond. They want to automate conversations. Businesses want to manage leads. They want to provide real-time support on Instagram. This helps them achieve their goals.",
    },
  ];
  // 8rd
      ...
      <section className="bg-[#f7ebfc] pt-25 md:pt-35 px-4 sm:px-6 lg:px-20">
        <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10 pb-5 lg:pb-10">
          <div className="space-y-6 box-reveal-left">
            ...
            <div className="box-reveal-left space-y-6">
              <h1 className="text-4xl  lg:text-5xl 2xl:text-6xl heading  font-bold text-gray-900 popf leading-tight">
                Never Miss a DM Again with Real-Time{" "}
              ...
              <p className="text-gray-600 text-base md:text-lg ">
                Manage all of your Instagram direct messages from one powerful
                inbox. Answer questions faster, stay organized, and give your
                customers the help they really want -All without leaving your
                platform.
              </p>
          ...
          <div className="flex justify-center ">
            <Image
              src={InstagramLiveChatService}
              alt="integration icon"
              // loading="eager"
              // fetchpriority="high"
              // crossorigin="anonymous"
              title="Integration Live Chat"
      ...
      <section className="bg-[#f7ebfc] py-2 lg:py-10 px-4 sm:px-6 lg:px-25">
        <div className="text-center px-1 md:px-4 pb-5 md:pb-10 lg:pb-15">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold text-gray-900 popf heading mb-2">
            Instagram Live Chat - Turns Every Message into Opportunity
          </h2>
          ...
          <div className="flex flex-col items-center lg:items-end gap-2 lg:gap-6 md:px-0 px-5 mb-1 md:mb-0">
            ...
            <div className="relative max-w-lg w-full ml-0 lg:w-90% lg:ml-10">
              ...
              <div className="bg-white border border-black rounded-[20px] p-5 pl-8 relative z-0">
                ...
                <p className="text-md text-black pera ml-2 text-justify">
                  All your Instagram DMs, organized in one powerful dashboard.
                  Filter conversations, manage chat status active or inactive,
                  track conversations in real-time, and ensure every message
            ...
            <div className="relative max-w-lg w-full lg:w-90% mr-0 lg:mr-10">
              ...
              <div className="bg-white border border-black rounded-[20px] p-5 pl-8 relative z-0">
                ...
                <p className="text-md text-black pera ml-2 text-justify">
                  Enhance every conversation with built-in profile insights. See
                  profile insights like follower count, following count, and
                  business follow status directly in the chat, and engage more
          ...
          <div className="flex flex-col items-center lg:items-start gap-2 lg:gap-6 md:px-0 px-5 mb-1 md:mb-0">
            ...
            <div className="relative max-w-lg w-full lg:w-90% lg:mr-10 mr-0">
              ...
              <div className="bg-white border border-black rounded-[20px] p-5 pl-8 relative z-0">
                ...
                <p className="text-md text-black pera ml-2 text-justify">
                  Interactive message templates with clickable action buttons,
                  such as "Book a Demo" or "Track Order," that point the user to
                  their next task. Break down the conversation into actions
                  through interactive message templates. Focus on key tasks,
                  reduce manual effort, and increase overall engagement.
                </p>
              </div>
            </div>
            ...
            <div className="relative max-w-lg w-full lg:w-90% lg:ml-10 ml-0">
              ...
              <div className="bg-white border border-black rounded-[20px] p-5 pl-8 relative z-0">
                <h4 className="text-base sm:text-lg font-bold text-black mb-1 heading ml-2">
                  2-hour window tracker
                </h4>
                <p className="text-md text-black pera ml-2 text-justify">
                  Stay in control of every conversation with real-time
                  visibility into your response window—ensuring compliant,
                  timely, and seamless customer interactions.
                </p>
              </div>
            </div>
            ...
            <div className="relative max-w-lg w-full lg:w-90% lg:mr-10 mr-0">
              ...
              <div className="bg-white border border-black rounded-[20px] p-5 pl-8 relative z-0">
                ...
                <p className="text-md text-black pera ml-2 text-justify">
                  You can easily handle many Instagram business accounts from
                  one place. Switch accounts in seconds, handle conversations
                  quickly, and make things easier for growing agencies and
                  teams.
                </p>
              </div>
            </div>
      ...
      <div className="bg-[#F7EBFC] py-2 md:py-16 px-6 sm:px-10">
        ...
        <div className="text-center px-1 md:px-4 pb-5">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-black text-center heading mb-2">
            Why Celitix's Instagram Live Chat Makes It Better
          </h2>
          {/* <p className="text-sm md:text-lg sub-heading max-w-6xl mx-auto text-gray-700 ">
        ...
        <div className="max-w-screen-2xl mx-auto flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 lg:gap-20 px-8">
          ...
          <div className="flex items-center justify-center w-full lg:w-1/2">
            <div className="w-full h-full my-5">
              <Image
                src={InstagramLiveChatMakesBetter}
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            <div className="space-y-4">
              {[
                {
                  title: "Real-Time Instagram Responses.",
                  content:
                    "Stay responsive on Instagram at all times with instant replies. Engage users immediately, resolve queries faster, and keep conversations active to capture every potential lead and conversion opportunity. Convert conversations into leads with faster reply times.",
                },
                {
                  title: "Chat appears in your live inbox",
                  content:
                ...
                {
                  title: "Guide customers with smart menus",
                  content:
                    "Create icebreakers and a Persistent Menu so people always know where to begin. Providing clear entry points, reducing repetitive questions, creating a smoother first impression every time, such as' Get a Quote’, ‘Book a Demo’, or ‘Talk To Support’, helps lead users in the right direction instantly without demanding too much.",
                },
              ].map((item, index) => (
                <div key={index}>
                  {/* Clickable Title Box */}
              ...
              <div className="flex flex-col lg:flex-row h-full">
                ...
                <div className="w-full lg:w-[48%] p-6 md:p-8">
                  ...
                  <p className="text-[16px] md:text-[18px] leading-[1.6] text-[#111827] pera text-justify">
                    ...
                    photos, videos, GIFs, and documents without switching tabs.
                  </p>
                </div>
              ...
              <div className="flex flex-col lg:flex-row h-full">
                ...
                <div className="w-full lg:w-[48%] p-6 md:p-8">
                  ...
                  <p className="text-[16px] md:text-[18px] leading-[1.6] text-[#111827] pera text-justify">
                    ...
                    information is easily accessible from the chat sidebar.
                    Respond with context, not random guesses.
                  </p>
                </div>
      ...
      <section className=" bg-[#f7ebfc] py-2 md:py-10 px-4 sm:px-6 lg:px-10">
        <div className="max-w-screen-2xl mx-auto">
          <div className="text-center px-1 md:px-4 pb-2 md:pb-10">
            <h2 className="text-2xl md:text-4xl lg:text-5xl heading font-semibold text-gray-900 mb-2">
              Instagram Live Chat: Engage. Support. Convert.
            </h2>
            {/* <p className="text-sm md:text-lg sub-heading max-w-6xl mx-auto text-gray-700 ">
              Handle conversations faster, automate responses, and give your
              team complete control over every customer interaction.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 items-center">
            ...
            <div className="space-y-6 px-0 2xl:px-5">
              <div className=" text-left space-y-2">
                ...
                <ul className="text-gray-700 space-y-2 text-md sub-heading text-justify">
                  {[
                    "Link your Instagram business account in minutes",
                    "Sync all DMs into one shared team inbox",
                    "Integrate with your CRM, helpdesk, or website",
                  ].map((text, i) => (
                    <li
                      key={i}
              ...
              <div className=" text-left space-y-2">
                ...
                <ul className="text-gray-700 space-y-2 text-md sub-heading text-justify">
                  {[
                    "Send images, videos, GIFs, and documents in chat",
                    "Use button templates to drive customer actions",
                    "Reply with canned responses for faster support",
                  ].map((text, i) => (
                    <li
                      key={i}
                      className="flex justify-start items-start gap-2"
            ...
            <div className="space-y-6 px-0 2xl:px-5">
              <div className="text-left space-y-2">
                <h3 className="text-base sm:text-lg font-semibold heading">
                  Engage & notify customers
                </h3>
                <ul className="text-gray-700 space-y-2 text-md sub-heading text-justify">
                  {[
                    "Set up icebreakers to welcome every new DM",
                    "Auto-assign chats to the right agent instantly",
                    "Respond within the 2-hour Meta window with ease.",
                  ].map((text, i) => (
              ...
              <div className="text-left space-y-2">
                ...
                <ul className="text-gray-700 space-y-2 text-md sub-heading text-justify">
                  {[
                    "Track every Instagram interaction from one dashboard",
                    "Combine Instagram with WhatsApp and other channels",
                    "Let customers reach you the way they prefer",
                  ].map((text, i) => (
                    <li key={i} className="flex items-start gap-2">
                      <CheckCircleIcon
                        className="text-blue-500 mt-0.5"
