...
const Header = () => {
  ...
  const iconMap = {
    ...
    Instagram: <Image src={Instagramicon} alt="SMS" className="w-6 h-6 mt-1" />,
    Authentication: (
      <Image src={Authenticationicon} alt="SMS" className="w-6 h-6 mt-1" />
    ),
    OBD: <Image src={OBDicon} alt="SMS" className="w-6 h-6 mt-1" />,
    IBD: <Image src={IBDicon} alt="SMS" className="w-6 h-6 mt-1" />,
    "Missed Call": (
      <Image src={MissedCallicon} alt="SMS" className="w-6 h-6 mt-1" />
    ),
    Click2Call: (
      <Image src={Click2callicon} alt="SMS" className="w-6 h-6 mt-1" />
    ),
    ...
    "Food Production": (
      <Image src={FoodProductionicon} alt="SMS" className="w-6 h-6" />
    ),
    "Service-Based": (
      <Image src={ServiceBasedicon} alt="SMS" className="w-6 h-6" />
    ),
    "Tech Startups": (
      <Image src={TechStartupsicon} alt="SMS" className="w-6 h-6" />
    ),
  };
  ...
  return (
    <>
      ...
      <nav
        className={` lg:px-12 md:px-10 px-0 fixed w-full z-50 transition-all duration-500 comicf ease-in-out ${
      ...
      >
        <div className="flex items-center justify-between px-4 md:px-6 py-4 bg-white md:rounded-2xl shadow-md relative">
                ...
                <div className="absolute -left-40 top-full grid grid-cols-2 lg:grid-cols-2 md:grid-cols-2 gap-6 bg-white text-black border border-gray-200 shadow-lg p-6 rounded-md w-[600px] ">
                  ...
                  <div className="w-full grid grid-cols-1 popfh sm:grid-cols-1 md:grid-cols-1 gap-1 p-1">
                    ...
                    <Link href="/click-to-call">
                      <ChannelItem
                        title="Click2Call"
                        desc="Best For User Experience"
                      />
                    </Link>
                    <Link href="/missed-call-services">
                      <ChannelItem
                        title="Missed Call"
                        desc="Most Customizable"
                      />
                    </Link>
          ...
          group-hover:scale-100 transition-all duration-500 ease-out z-50 "
            ...
            <div className="relative group cursor-pointer">
              ...
              {/* Dropdown */}
              <div
                className="absolute left-1/2 top-9 mt-2 transform -translate-x-1/2 z-50
          ...
          <div className="hidden xl:flex flex-shrink-0 gap-3">
            ...
            <UniversalButton
              label="Book Demo"
              variant="brutal"
              className="bg-[#9B44B6] border-[#9B44B6] text-white px-2 py-1 font-semibold hover:bg-white hover:text-black 
        ...
        {mobileMenuOpen && (
          <div className="xl:hidden bg-white shadow-md px-4 pt-2 -mt-2 pb-4 space-y-3 text-sm font-medium text-black transition-all duration-300 rounded-b-2xl overflow-y-auto">
            <div className="relative group cursor-pointer mb-0">
              <Link href="/cpaas-solutions">
            ...
            >
              ...
              >
                Channels{" "}
                <MdKeyboardArrowDown
                  className={`${isChannelsOpen ? "rotate-180" : ""} transition-transform duration-300`}
                />
              </div>
        ...
        ${isIndustriesOpen ? "block" : "hidden"} grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2
          w-full md:w-[800px] max-h-[80vh] overflow-y-auto`}
              >
                ...
                <Link
                  href="/construction-and-real-estate"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <ResourcesItem title="Real Estate" />
                </Link>
