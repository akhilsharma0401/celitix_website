...
const Sms = ({ params }) => {
  ...
  const features = [
    {
      title: "Transactional SMS, OTP, Alerts, Updates",
      imgSrc: TransactionalSMS,
    },
      ...
      <div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10 pb-10 md:pb-20">
            <div className="space-y-6 box-reveal-left">
              ...
              <p className="text-gray-600 text-base md:text-lg max-w-md pera">
                Connect with every customer through fast, reliable and low-cost
                SMS messaging + SMS API Integration.
              </p>
            ...
            <div className="flex flex-col items-center lg:items-end gap-2 lg:gap-6 md:px-0 px-5 mb-1 md:mb-0">
              ...
              <div className="relative max-w-md w-full ml-0 lg:w-90% lg:ml-10">
                ...
                <div className="bg-white border border-black  rounded-[20px] p-5 pl-8 relative z-0">
                  <h3 className="text-base sm:text-lg heading  font-bold text-black mb-1 ml-4">
                    Notify 24/7{" "}
                  </h3>
                  <p className="text-md text-black pera ml-4">
                    Automatically update your customers in real time. Integrate
                    your system with Celitix’s SMS API.
                  </p>
                </div>
              </div>
              ...
              <div className="relative max-w-md w-full lg:w-90% mr-0 lg:mr-10">
                ...
                <div className="bg-white border border-black rounded-[20px] p-5 pl-8 relative z-0">
                  ...
                  <p className="text-md text-black pera ml-4">
                    The most reliable and trusted channel for secure OTP &
                    2-Factor Authentication on Celitix.
                  </p>
                </div>
              </div>
              ...
              <div className="relative max-w-md w-full ml-0 lg:w-90% lg:ml-10">
                ...
                <div className="bg-white border border-black rounded-[20px] p-5 pl-8 relative z-0">
                  ...
                  <p className="text-md text-black pera ml-4">
                    Send SMS in any local language. Reach users in their mother
                    tongue and get better results.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center lg:items-start gap-2 lg:gap-6 md:px-0 px-5 mb-1 md:mb-0">
              ...
              <div className="relative max-w-md w-full lg:w-90% lg:mr-10 mr-0">
                ...
                <div className="bg-white border border-black rounded-[20px] p-5 pl-8 relative z-0">
                  ...
                  <p className="text-md text-black pera ml-4">
                    Use approved templates and sender IDs to build trust.
                    Celitix simplifies the rules for you.
                  </p>
                </div>
              </div>
              ...
              <div className="relative max-w-md w-full lg:w-90% lg:ml-10 ml-0">
                ...
                <div className="bg-white border border-black rounded-[20px] p-5 pl-8 relative z-0">
                  ...
                  <p className="text-md text-black pera ml-4">
                    Reach users across borders through global SMS routes. For
                    SaaS, Tech, & global
                  </p>
                </div>
              </div>
              ...
              <div className="relative max-w-md w-full lg:w-90% lg:mr-10 mr-0">
                ...
                <div className="bg-white border border-black rounded-[20px] p-5 pl-8 relative z-0">
                  ...
                  <p className="text-md text-black pera ml-4">
                    An ideal automated fallback. For when channels like Voice,
                    RCS or WhatsApp are unsuccessful.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-[#f7ebfc] py-5 md:py-16 px-4 sm:px-6 lg:px-20">
          <div className="text-center px-1 md:px-4 pb-5 md:pb-15">
            ...
            <p className="text-sm md:text-xl sub-heading font-semibold text-gray-700">
              SMS API is urgent, reliable, & developer-friendly. Add it to any
              channel with Celitix.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4 bg-[#FFFFFF] p-6 rounded-3xl">
                ...
                <div>
                  ...
                  <p className="text-md text-gray-800 leading-relaxed pera">
                    Trigger OTPs, alerts, or promos automatically from your CRM,
                    app or system. Deliver to users who don’t have internet.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-[#FFFFFF] p-6 rounded-3xl">
                ...
                <div>
                  ...
                  <p className="text-md text-gray-800 leading-relaxed pera">
                    Auto-send SMS after users engage with missed call or 2-way
                    SMS campaigns. Craft seamless experiences across channels.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-[#FFFFFF] p-6 rounded-3xl">
                ...
                <div>
                  ...
                  <p className="text-md text-gray-800 leading-relaxed pera">
                    Build, measure, & manage smart flows with SMS fallbacks.
                    Manage onboarding, sales & more, all from one dashboard.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-wrap -mx-2 sub-heading">
            {features.map(({ title, imgSrc }, i) => (
              <div key={i} className="w-full sm:w-1/2 md:w-1/3 px-2 mb-4">
                ...
                >
                  <Image src={imgSrc} alt={title} className="w-8 h-8 mb-4" />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between bg-gradient-to-r from-[#A05CD7] to-[#4B0FA6] px-6 md:px-12 py-5 md:py-20">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="text-gray-200 text-sm sm:text-base md:text-lg font-light mb-6 max-w-xl sub-heading">
              Get the most out of SMS with automation, segmentation, and
              real-time analytics.
            </p>
            <UniversalButton
              label="Start Now "
