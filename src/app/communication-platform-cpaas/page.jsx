    ...
    return (
        <div className='bg-[#F6EDF9]'>
            ...
            <div className="px-4 lg:px-25 py-2 md:py-10 pt-25 md:pt-30">
                ...
                >
                    <h1 className="text-3xl md:text-5xl lg:text-6xl font-semibold text-gray-900 heading">All-in-One
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2b40b0] to-[#36bae2]"> Communication Platform </span>
                    </h1>
