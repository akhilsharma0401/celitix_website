...
import { CTALASTIMAGE, Ecommerce, Education, Finance, FoodBeverage, Healthcare, Hospitality, ProfessionalServices, RealEstateConstruction, TechStartups, Travel2nd, Travel4th1, Travel4th2, Travel4th3, TravelBring, Travelhero, TravelReduce, TravelSimplify, TravelStay } from '../../../public/assets/images';
...
const Tourism = () => {
  ...
  const features = [
    {
      title: "Stay Available, Always",
      desc: "Share booking details, location guides, or schedule changes instantly. Automate FAQs & 24/7 support.",
      icon: TravelStay,
    },
    {
      title: "Reduce No-Shows ",
      desc: "Send confirmations, check-in links, and reminders automatically. Nudge gently. Boost occupancy.",
      icon: TravelReduce,
    },
    {
      title: "Simplify Guest Support  ",
      desc: "Let guests ask questions via chat. Route issues to staff. Automate common queries with smart replies.",
      icon: TravelSimplify,
    },
    {
      title: "Bring Them Back",
      desc: "Follow up after check-out. Ask for feedback. Send seasonal promos or loyalty rewards that feel personal.",
      icon: TravelBring,
    },
  ];
  // 2nd
  ...
  // 4th
  const [mainTab, setmainTab] = useState("Easy Bookings");

  const maintabs = ["Easy Bookings", "Better Stay", "Promotions"];

  const maintabContent = {
    "Easy Bookings": [
      "Send booking confirmations and payment receipts instantly.",
      "Share directions, hotel info, or itinerary PDFs over WhatsApp.",
      "Reduce missed check-ins with timed SMS & voice reminders.",
      "Answer FAQs with auto-replies before or after check-in.",

    ],
    "Better Stay": [
      "Share welcome messages and room service menus on arrival.",
      "Offer guided tour info, dinner reservations, or spa slots via chat.",
      "Let guests raise issues or make requests through WhatsApp.",
      "Collect feedback, give recommendations, and much more.",

    ],
    "Promotions": [
      "Send thank-you messages or promo codes after checkout.",
      "Run loyalty and referral programs with WhatsApp coupons.",
      "Invite past guests to seasonal offers or exclusive events.",
      "Share feedback forms to improve future stays.",

    ],
  };

  const tabImages = {
    "Easy Bookings": Travel4th1,
    "Better Stay": Travel4th2,
    "Promotions": Travel4th3,
  };
  // 4th
  ...
  const tabs = [
    "Ecommerce", "Healthcare", "Finance", "Education",
  ...
  const faqs = [
    {
      question: "Can I send booking and check-in details via WhatsApp?",
      answer:
        "Yes. Celitix lets you share confirmations, receipts, and welcome info securely over WhatsApp and SMS.",
    },
    {
      question: "Will this work with my existing booking system?",
      answer:
        "Yes. Celitix integrates via APIs or can work alongside your current tools, even if they’re basic or manual.",
    },
    {
      question: "Can I automate reminders and feedback collection?",
      answer:
        "Absolutely. Set up workflows to send timed check-in reminders, post-stay feedback requests, or upsell nudges.",
    },
    {
      question: "Can guests chat with my team in real time?",
      answer:
        "Yes. Enable WhatsApp or web chat with routing rules so the right staff can handle the right query quickly.",
    },
    {
      question: "What if a guest misses a message?",
      answer:
        "Celitix supports backup channels, so if WhatsApp is ignored, we can follow up via SMS or voice.",
    },
  ...
  return (
    <div>
      {/* <Helmet>
        <title> Guest Management Suite for Travel & Tourism | Celitix        </title>
        <meta name="description" content="Reduce cancellations, improve service, and grow bookings. Celitix helps hospitality teams through WhatsApp, RCS, SMS, Voice, and more." />
      </Helmet> */}
      {/* 1st */}
      <section className="bg-[#f7ebfc] pt-25 md:pt-35 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10 pb-10 md:pb-20">
          <div className="space-y-6 box-reveal-left">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl heading text-gray-900 popf leading-tight">
              Guide <span className="text-transparent bg-clip-text  bg-gradient-to-r from-[#2b40b0] to-[#36bae2]"> Travellers </span>with Celitix
            </h1>

            <p className="text-gray-600 text-base md:text-lg pera max-w-md">
              From itinerary updates to instant confirmations, Celitix helps you stay in touch, avoid cancellations, and deliver better service before, during, and after the trip.
      ...
      <section className="bg-[#f7ebfc] px-4 sm:px-6 lg:px-20 py-5 md:py-10">
        <div className="max-w-screen-xl mx-auto">
          <h2 className="text-2xl md:text-4xl lg:text-5xl heading text-center pb-5 md:pb-15">
            Smarter Service, Happier Guests
          </h2>
        ...
        <div className=" bg-linear-to-r from-[#6b0da1] to-[#8447c6] grid grid-cols-1 md:grid-cols-2 h-auto py-10 px-6 sm:px-8 rounded-3xl shadow-2xl w-full sm:w-11/12 md:w-11/12 mx-auto items-center gap-8">
          ...
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            <p className="text-sm md:text-lg sub-heading text-white font-light popf mt-2">
              Celitix helps travel brands reduce workload, improve service, and grow retention without chasing after every message.
      ...
      <section className="bg-[#f7ebfc] px-4 sm:px-6 md:px-12 py-5 md:py-20">
        <div className=" max-w-screen-xl mx-auto">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl pb-2 md:pb-5 text-center heading text-purple-800 mb-3">
            For Hosts, Hotels & Holiday Planners
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="max-w-xl mx-auto lg:mx-0 text-gray-800">
              <h3 className="text-xl md:text-3xl sub-heading text-purple-700 mb-4">
                {mainTab === "Easy Bookings"
                  ? "Automations That Improve Service"
                  : mainTab === "Better Stay "
                    ? "Elevate The Guest Experience"
                    : "Stay Connected & Book More"}
              </h3>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between bg-gradient-to-r from-[#A05CD7] to-[#4B0FA6] px-6 md:px-12 py-5 md:py-20">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h2 className="text-white  text-2xl sm:text-3xl md:text-4xl heading font-bold mb-4">
            Make Every Stay Smoother
          </h2>
          <p className="text-gray-200 text-sm sm:text-base md:text-lg sub-heading font-light mb-6 max-w-xl">
            From booking to check-out, Celitix helps you keep guests informed, reduce stress on staff, and drive repeat business.
          </p>
          <UniversalButton
            label="Start Now"
            variant="transitionbtn"
      ...
      {/* 5th */}
      {/* 6th */}
      <div className="bg-[#f7ebfc] py-16 px-6 sm:px-10">
        {/* Heading */}
      ...
      {/* 6th */}
      {/* 7th */}
      <div className="min-h-screen bg-[#f7ebfc] flex justify-center items-center py-2 md:pb-15 px-4">
