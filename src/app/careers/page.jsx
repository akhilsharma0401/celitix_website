...
Should have good communication skills.`,
    },
    {
      ...
      Graphic: `Expert level skills of Photoshop, Corel, Illustrator and other tools as required. A portfolio (preferably on the internet) is required for judging design skills. A go-getter attitude and the ability to explore various artistic styles that can be applied to social media is necessary.`,
    },
    {
      ...
      Sales: `Should have a Bachelor's Degree.
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10      pb-2 md:pb-10">
          <div className="space-y-6 box-reveal-left">
            ...
            <p className="text-gray-600 text-base md:text-lg max-w-md sub-heading">
              Join a team that’s transforming how companies connect with their
              customers across Messaging, Voice calling, and beyond.
            </p>
      ...
      <section className="bg-[#f7ebfc] py-2 lg:py-10 px-4 md:px-20 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="relative bg-white border border-black rounded-2xl p-6 shadow-sm hover:shadow-md transition duration-300">
            ...
            <h3 className="text-lg md:text-xl heading text-gray-800 mb-1 mt-5">
              Grow Potential
            </h3>
            <p className="text-sm md:text-lg text-purple-600 sub-heading font-medium mb-2">
              Learn | Innovate | Evolve
            </p>
            <p className="text-sm md:text-lg pera text-gray-600">
              Embrace change and continuous learning to stay ahead in dynamic
              markets.
            </p>
          </div>
          ...
          <div className="relative bg-white border border-black rounded-2xl p-6 shadow-sm hover:shadow-md transition duration-300">
            ...
            <p className="text-sm md:text-lg text-purple-600 sub-heading font-medium mb-2">
              Share | Create | Elevate
            </p>
            <p className="text-sm md:text-lg pera text-gray-600">
              Foster a collaborative spirit that sparks innovation and drives
              success.
            </p>
          </div>
          ...
          <div className="relative bg-white border border-black rounded-2xl p-6 shadow-sm hover:shadow-md transition duration-300">
            ...
            <p className="text-sm md:text-lg text-purple-600 sub-heading font-medium mb-2">
              Empathy | Partner | Empower
            </p>
            <p className="text-sm md:text-lg pera text-gray-600">
              Put clients first, understand their needs, deliver, and grow
              together.
            </p>
          </div>
        </div>
      ...
      <section className="bg-[#f7ebfc] py-2 md:py-10 pt-2 md:pt-10">
        <div className=" bg-linear-to-r from-[#6b0da1] to-[#8447c6] grid grid-cols-1 md:grid-cols-1 h-auto py-10 px-6 sm:px-8 rounded-3xl shadow-2xl w-full sm:w-11/12 md:w-11/12 mx-auto items-center gap-8">
          ...
          <div className="flex flex-col justify-center items-center text-center">
            <h4 className="text-lg md:text-3xl sub-heading text-white">
              {" "}
              ...
              {jobOpenings.map((job, index) => (
                ...
                >
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-4 py-3 text-left font-medium text-sm sm:text-base transition ${
                      openIndex === index
              ...
              <div className="bg-white border border-gray-300 pera rounded-xl p-1 shadow-sm md:p-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <select
                      name="selectExpyrs"
                      value={form.selectExpyrs}
                      onChange={(e) =>
                        setForm({ ...form, selectExpyrs: e.target.value })
                      }
                      className="form-select w-full border border-gray-300 rounded-md p-2 text-gray-500"
                    >
                      <option value="" disabled>
