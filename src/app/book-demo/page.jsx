...
import { homesecond1, homesecond10, homesecond11, homesecond2, homesecond3, homesecond4, homesecond5, homesecond6, homesecond7, homesecond8, homesecond9 } from "../../../public/assets/images";
                        ...
                        <div className="px-5">
                            ...
                            <ul className="space-y-4 text-gray-900 text-md">
                                <li className="flex gap-3 pera">
                                    ...
                                    Whatsapp business API,SMS ,RCS . Chatbot Automation plan customized for your business goals
                                </li>
                                <li className="flex gap-3 pera">
                                    <span className="text-green-600 text-lg">✔</span>
                                ...
                                <li className="flex gap-3 pera">
                                    <span className="text-green-600 text-lg">✔</span>
                                    Expert guidance on compliance, message templates, and delivery success
                                </li>
                                <li className="flex gap-3 pera">
                                    <span className="text-green-600 text-lg">✔</span>
                            ...
                            <div className="border rounded-lg mt-8 p-6 bg-gray-50">
                                ...
                                <p className="text-gray-700 pera text-lg mb-4">
                                    Discover how automation can simplify your customer communication.
                                    Get started with SMS,IVR,Whatsapp Business API, RCS and more.
            ...
            <div className="Second bg-[#D8E3F5] py-2 md:py-15">
                <div className="text-center px-4 pb-5 md:pb-15">
                    <h2 className="text-lg md:text-3xl font-semibold text-gray-900 popf">
                        Companies build with Celitix.
                        Leverage with Celitix’s scalability and reliability
