...
const Landingpagel1 = () => {
  ...
  const channels = [
    {
      ...
      description:
        "Seamlessly connect customers to your business from your website, app, ads, or emails",
    },
    {
      title: "Missed Call Services",
      icon: "/icons/missed-call.svg",
      description:
        "Customisable tool for lead gen, engagement, & more with IVR & other integrations",
    },
    {
      title: "WhatsApp",
      icon: "/icons/whatsapp.svg",
      description:
        "Connect with customers where they are and leverage the world's biggest messaging platform",
    },
    {
      title: "RCS",
      icon: "/icons/rcs.svg",
      description:
        "Differentiate yourself from the competition and get the first mover's advantage in key metro cities",
    },
  ];
  ...
  const prev = () =>
    setActive((active - 1 + channels.length) % channels.length);
            ...
            <div className="flex justify-start items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-gray-600 text-md md:text-lg pera md:max-w-md">
                  Get better returns on investment (ROI) with simpler,
                  strategic, data-driven communication systems. Standardise,
                  automate and manage your business’s marketing, sales, and
                  support procedures from a single platform.
                </p>
              </div>
            </div>
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start">
                ...
                <span className="ml-3 sub-heading text-gray-800">
                  <strong>Text Messaging:</strong> Marketing + Automation on
                  SMS, RCS & WhatsApp
                </span>
              </li>
              <li className="flex items-start">
                ...
                />
                <span className="ml-3 sub-heading text-gray-800">
                  <strong>Voice Calling:</strong> Ultimate call management for
                  Support & Outreach
                </span>
              </li>
              <li className="flex items-start">
                ...
                />
                <span className="ml-3 sub-heading text-gray-800">
                  <strong>App Development:</strong> Developer-friendly APIs &
                  other CPaaS solutions
                </span>
              </li>
              <li className="flex items-start">
                ...
                />
                <span className="ml-3 sub-heading text-gray-800">
                  <strong>Integrations:</strong> Combine, connect & collaborate
                  to boost results
                </span>
              </li>
            </ul>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 grid-cols-1 gap-10">
          ...
          <div className="flex justify-center items-center h-full lg:justify-start">
            <div className="text-left">
              ...
              <h2 className="text-3xl md:text-4xl heading font-bold text-gray-900 mb-4">
                Stronger communication builds trust, boosts morale, and delivers
                results
              </h2>
              <UniversalButton
                label=" Consult Expert"
          ...
          <div className=" grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600 sub-heading text-md">
                Indian consumers feel that service is just an afterthought for
                companies
              </p>
            </div>
      ...
      <div className="w-full px-4 py-5 md:py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-xl sub-heading text-gray-700 mb-4 md:mb-15">
            Integrate these channels with existing ones, or build custom
            workflows.
          </p>
              ...
              {cards.map((c, i) => (
                ...
                "
                  >
                    ...
                    />
                    <h3 className="text-lg sub-heading font-medium mb-2">
                      {c.title}
                    </h3>
          ...
          <div className="flex justify-center items-center h-full lg:justify-start">
            <div className="w-full lg:text-left lg:mt-5">
              ...
              <p className="text-gray-600 mb-6 sub-heading text-lg ">
                Make marketing profitable. Engage, convert, and retain
                customers. Lead, manage, and assist your team. Build, automate,
                and integrate your apps/platform at a fraction of the cost.
              </p>
              <UniversalButton
                label="Book Demo"
                type="submit"
